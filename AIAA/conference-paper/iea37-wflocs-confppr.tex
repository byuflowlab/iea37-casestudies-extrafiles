...
\todo[inline, color=red!40]{Incude a participant information list? (not assigned numbers, just individuals and sponsoring institutions)}
\newpage
\label{app:cs2-layouts}
\includepdf[pages={-},scale=.8,pagecommand={\section{Pictoral Representations of Case Study 2's Participant Submissions}\label{pdf:myfile}},linktodoc=true]{./figures/iea37-opt9-5plots.pdf}
\includepdf[pages={-},scale=.9,pagecommand={\section{Pictoral Representations of Case Study 1's 16-Turbine Submissions}\label{pdf:myfile}},linktodoc=true]{./figures/iea37-opt16-10plots.pdf}
\includepdf[pages={-},scale=.9,pagecommand={\section{Pictoral Representations of Case Study 1's 36-Turbine Submissions}\label{pdf:myfile}},linktodoc=true]{./figures/iea37-opt36-10plots.pdf}
\includepdf[pages={-},scale=.9,pagecommand={\section{Pictoral Representations of Case Study 1's 64-Turbine Submissions}\label{pdf:myfile}},linktodoc=true]{./figures/iea37-opt64-10plots.pdf}
%\section{Python Code}
%\label{app:aepcalc}
