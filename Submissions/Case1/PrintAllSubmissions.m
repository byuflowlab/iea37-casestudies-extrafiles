...
bDispAEP = true;        % if True, shows calculations in command window
bWriteYaml = false;     % If True, writes calculated AEP data to a .yaml file
bDispFarm = false;      % If True, displays a fig of the wind farm
...
bSaveFig = false;       % If True, saves the WFL figure.
...
for nFarmSize = 2:2          % Do all the farm sizes
    ...
    for nParNum = 10:10   % Do all the participants
