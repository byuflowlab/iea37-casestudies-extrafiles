...
% Modified 6 Feb 2019 for farm sizes in second round of case studies.
clear all, close all;
...
FarmSize = 4;               % 1 = 16 turbines, 2 = 36 turbines, 3 = 64 turbines.
...
switch(FarmSize)
    ...
    case 4
        nNumTurbField = 4;                  % Overall number of turbines in the field.
        fFieldRad = 900;
    case 5
        nNumTurbField = 64;                 % Overall number of turbines in the field.
        fFieldRad = 3000;
