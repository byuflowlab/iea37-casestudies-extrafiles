function [turb_ci, turb_co, rated_ws, rated_pwr, turb_diam] = getTurbineYaml(file_name)
    ...
    op_props = defs.operating_mode(1);
    turb_props = defs.wind_turbine(1);
    rotor_props = defs.rotor(1);
    ...
    rated_pwr = turb_props.rated_power(1).maximum(1);
    turb_diam = rotor_props.diameter(1).default(1);
end