function [] = writeTurbLocYAML(file_name, turb_coords, fname_turb, fname_wr, binned_AEP)
    ...
    File.title = 'Output file for the 25 turbine wind plant model for IEA Task 37 case study 3';
    ...
    File.definitions.position.description = 'an array of x and y-coordinates [x0, y0 \n x1, y1 \n ...] of wind turbine positions in cartesian coordinates';
