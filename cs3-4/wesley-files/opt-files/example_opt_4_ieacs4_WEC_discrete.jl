...
initial_yaml = YAML.load(open("../initial-layouts/ieacs4_initial_layout-"*lpad(layout_number,3,"0")*".yaml"))
...
# save current figure
savefig("../results/opt_plot-"*lpad(layout_number,3,"0")*"-1")
...
options["Summary file"] = "snopt-output/summary-ieacs4-WEC-"*lpad(layout_number,3,"0")*"-discrete2.out"
options["Print file"] = "snopt-output/print-ieacs4-WEC-"*lpad(layout_number,3,"0")*"-discrete2.out"
...
# save current figure
savefig("../results/opt_plot-"*lpad(layout_number,3,"0")*"-2")
...
# write out txt file with nearest_region
open("nearest_region_ieacs4-"*lpad(layout_number,3,"0")*".txt", "w") do io
    writedlm(io, nearest_region)
end
...
options["Summary file"] = "snopt-output/summary-ieacs4-WEC-"*lpad(layout_number,3,"0")*"-discrete3.out"
options["Print file"] = "snopt-output/print-ieacs4-WEC-"*lpad(layout_number,3,"0")*"-discrete3.out"
...
# save current figure
savefig("../results/opt_plot-"*lpad(layout_number,3,"0")*"-3")
...
for i in 2:length(wec_values)
    ...
    # change output file names
    options["Summary file"] = "snopt-output/summary-ieacs4-WEC-"*lpad(layout_number,3,"0")*"-discrete" * "$(i+2)" * ".out"
    options["Print file"] = "snopt-output/print-ieacs4-WEC-"*lpad(layout_number,3,"0")*"-discrete" * "$(i+2)" * ".out"
...
# save current figure
savefig("../results/opt_plot-"*lpad(layout_number,3,"0")*"-4")

# rename output files
options["Summary file"] = "snopt-output/summary-ieacs4-WEC-"*lpad(layout_number,3,"0")*"-discrete" * "$noptimizations" * "-final.out"
options["Print file"] = "snopt-output/print-ieacs4-WEC-"*lpad(layout_number,3,"0")*"-discrete" * "$noptimizations" * "-final.out"
...
# write xopt values to txt files
display(xopt_all)
open("../results/xopt_all_ieacs4_WEC_discrete-"*lpad(layout_number,3,"0")*".txt", "w") do io
    writedlm(io, xopt_all)
end

# write intermediate results to yaml files
ff.write_turb_loc_YAML("../results/iea37-byu-opt4-intermediate-"*lpad(layout_number,3,"0")*".yaml",turbine_x,turbine_y,
