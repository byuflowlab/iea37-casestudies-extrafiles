...
# save current figure
savefig("../results/opt_plot_WEC_discrete_fullwindrose1")
...
options["Summary file"] = "summary-ieacs4-WEC-discrete-fullwindrose2.out"
options["Print file"] = "print-ieacs4-WEC-discrete-fullwindrose2.out"
...
# save current figure
savefig("../results/opt_plot_WEC_discrete_fullwindrose2")
...
options["Summary file"] = "summary-ieacs4-WEC-discrete-fullwindrose3.out"
options["Print file"] = "print-ieacs4-WEC-discrete-fullwindrose3.out"
...
# save current figure
savefig("../results/opt_plot_WEC_discrete_fullwindrose3")
...
for i in 1:length(wec_values)
    ...
    # change output file names
    options["Summary file"] = "summary-ieacs4-WEC-discrete-fullwindrose" * "$(i+3)" * ".out"
    options["Print file"] = "print-ieacs4-WEC-discrete-fullwindrose" * "$(i+3)" * ".out"
...
# save current figure
savefig("../results/opt_plot_WEC_discrete_fullwindrose4")
...
# rename output files
options["Summary file"] = "summary-ieacs4-WEC-discrete-fullwindrose" * "$noptimizations" * "-final.out"
options["Print file"] = "print-ieacs4-WEC-discrete-fullwindrose" * "$noptimizations" * "-final.out"
...
xlim(0, 11000)
ylim(-500, 13000)
savefig("../results/opt_plot_WEC_discrete_fullwindrose5")
